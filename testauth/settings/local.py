...
# to https://recruit.com/sso/callback
# substituting your domain for recruit.com
...
ESI_USER_CONTACT_EMAIL = "dummy@recruit.net"
...
# Set the default from email to something like 'noreply@recruit.com'
